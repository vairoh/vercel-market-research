...
const BUYER_PERSONAS = [
  {
    id: "CTO",
    label: "CTO / Platform teams",
    example: "Automate infrastructure at scale",
  },
  { id: "CFO", label: "CFO / FinOps", example: "Reduce cloud spend by 30%" },
  {
    id: "CISO",
    label: "CISO / Legal",
    example: "Ensure compliance with EU regulations",
  },
  {
    id: "ESG",
    label: "Sustainable Heads / ESG",
    example: "Meet CSRD reporting requirements",
  },
];
  ...
  const validateStep = (step: Step) => {
    ...
    if (step === "GENERAL") {
      if (!formData.candidate_name.trim())
        newErrors.candidate_name = "Researcher name required.";
      if (!formData.hq_country.trim())
        newErrors.hq_country = "HQ Country required.";
      if (!formData.company_website.trim())
        newErrors.company_website = "Website URL required.";
      if (!formData.year_founded.trim())
        newErrors.year_founded = "Founding year required.";
    }
    setErrors(newErrors);
      ...
      >
          ...
          <div className="animate-fade-in">
            ...
            <div style={{ display: "grid", gap: "2.5rem" }}>
              ...
              >
                <div>
                  ...
                  <input
                    ...
                    style={{
                      borderColor: errors.candidate_name
                        ? "#ef4444"
                        : "#e4e4e7",
                      width: "100%",
                      borderRadius: "12px",
                  ...
                  >
                    Enter your primary identification for the research log.
                  </div>
                </div>
                <div>
                  <label
                  ...
                  <input
                    ...
                    placeholder="YYYY"
                    style={{
                      borderColor: errors.year_founded ? "#ef4444" : "#e4e4e7",
                      width: "100%",
                      borderRadius: "12px",
                      padding: "0.85rem",
                    }}
                  ...
                  >
                    When was this company officially incorporated?
                  </div>
                </div>
              </div>
              ...
              >
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      handleInputChange("hq_country", e.target.value)
                    }
                    placeholder="Country"
                    style={{
                      borderColor: errors.hq_country ? "#ef4444" : "#e4e4e7",
                      width: "100%",
                      borderRadius: "12px",
                      padding: "0.85rem",
                    }}
                ...
                <div>
                  ...
                  >
                    Current approximate headcount from LinkedIn or official
                    reports.
                  </div>
                </div>
              </div>
              ...
              <div>
                  ...
                  {FUNDING_STAGES.map((stage) => {
                    ...
                    return (
                      <button
                        ...
                        type="button"
                        onClick={() =>
                          toggleArrayItem("funding_stage", stage.label)
                        }
                        style={{
                ...
                >
                  Select the most likely current financial phase based on recent
                  news.
                </div>
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="https://..."
                  style={{
                    borderColor: errors.company_website ? "#ef4444" : "#e4e4e7",
                    width: "100%",
                    borderRadius: "12px",
                    padding: "0.85rem",
                  }}
          ...
          <div className="animate-fade-in">
            ...
            <div style={{ display: "grid", gap: "3rem" }}>
              <div>
                ...
                >
                  What kind of service/product does this company provide?
                </label>
                <div
                  style={{ display: "flex", flexWrap: "wrap", gap: "0.75rem" }}
                >
                  {[
                    ...
                    return (
                      <button
                        ...
                        type="button"
                        onClick={() =>
                          toggleArrayItem("finops_categories", opt)
                        }
                        style={{
                          padding: "0.6rem 1.2rem",
                          borderRadius: "30px",
              ...
              <div>
                ...
                >
                  Who is the website content written for? Cross-reference
                  messaging with these target roles.
                </div>
                <div
                  style={{
                    display: "grid",
                ...
                >
                  {BUYER_PERSONAS.map((p) => {
                    ...
                    return (
                      <div
                        key={p.id}
                        onClick={() => toggleArrayItem("buyer_personas", p.id)}
                        style={{
                          padding: "1rem",
                          borderRadius: "16px",
                          border: `2px solid ${active ? "#000" : "#f4f4f5"}`,
                          cursor: "pointer",
                          transition: "0.2s",
              ...
              <div>
                ...
                >
                  Homepage Headline & Keywords
                </label>
                <input
                  value={formData.homepage_headline}
                  onChange={(e) =>
                    handleInputChange("homepage_headline", e.target.value)
                  }
                ...
                />
                <textarea
                  value={formData.keywords_raw}
                  onChange={(e) =>
                    handleInputChange("keywords_raw", e.target.value)
                  }
                  placeholder="Enter keywords separated by commas (e.g. AI, Scalability, Trust)..."
                  style={{
                    width: "100%",
                    minHeight: "80px",
                    borderRadius: "12px",
              ...
              <div>
                ...
                >
                  ...
                  >
                    <input
                      type="radio"
                      checked={formData.eu_reg_mention === "yes"}
                      onChange={() =>
                        handleInputChange("eu_reg_mention", "yes")
                      }
                    />{" "}
                    Explicit EU Mention
                  </label>
                  ...
                  >
                    <input
                      type="radio"
                      checked={formData.eu_reg_mention === "no"}
                      onChange={() => handleInputChange("eu_reg_mention", "no")}
                    />{" "}
                    No Mention
                  </label>
                </div>
                {formData.eu_reg_mention === "yes" && (
                  ...
                  >
                    {["EU AI Act", "GDPR", "Data Act", "NIS2", "CSRD"].map(
                      (reg) => (
                        <button
                          key={reg}
                          type="button"
                          onClick={() => toggleArrayItem("eu_reg_details", reg)}
                          style={{
                            padding: "0.5rem 1rem",
                            borderRadius: "8px",
                            fontSize: "0.7rem",
                            fontWeight: 700,
                            backgroundColor: formData.eu_reg_details.includes(
                              reg,
                            )
                              ? "#000"
                              : "#f4f4f5",
                            color: formData.eu_reg_details.includes(reg)
                              ? "#fff"
                              : "#000",
                            border: "none",
                            cursor: "pointer",
              ...
              <div>
                ...
                >
                  {CLOUD_PROVIDERS.map((cloud) => (
                    <span
                      key={cloud}
                      onClick={() => toggleArrayItem("cloud_providers", cloud)}
                      style={{
                        fontSize: "0.65rem",
                        fontWeight: 700,
                        ...
                        borderRadius: "6px",
                        cursor: "pointer",
                        backgroundColor: formData.cloud_providers.includes(
                          cloud,
                        )
                          ? "#000"
                          : "#f4f4f5",
                        color: formData.cloud_providers.includes(cloud)
                          ? "#fff"
                          : "#000",
                      }}
                    >
                ...
                <input
                  value={formData.custom_cloud}
                  onChange={(e) =>
                    handleInputChange("custom_cloud", e.target.value)
                  }
                  placeholder="New cloud provider..."
                  style={{
                    width: "100%",
                    borderRadius: "12px",
                    padding: "0.85rem",
            ...
            <div style={{ display: "grid", gap: "2rem" }}>
              <div>
                ...
                <textarea
                  ...
                  onChange={(e) =>
                    handleInputChange("evidence_links", e.target.value)
                  }
        ...
        >
          ...
          {currentStep !== "SUBMISSION" ? (
            ...
            >
              {submitting ? "UPLOADING..." : "SUBMIT RESEARCH"}
            </button>
          )}
        </div>
      </div>
